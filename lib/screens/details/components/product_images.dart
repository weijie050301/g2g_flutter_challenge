    ...
    return Column(
      children: [
        SizedBox(
          ...
          child: AspectRatio(
            aspectRatio: 1,
            child: Image.network(widget.product.shortScreenshots[selectedImage].image),
          ),
        ),
        // SizedBox(height: 20),
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...List.generate(
                widget.product.shortScreenshots.length,
                (index) => SmallProductImage(
                  ...
                  image: widget.product.shortScreenshots[index].image,
                ),
              ),
            ],
          ),
